...
const OFERTAS_ESTADOS = [
    { titulo: 'SEED - 30% en calzado (en espera)',   descripcion: 'Descuento en calzado deportivo', descuento: 30, tipo: 'porcentaje', costo_cupon: 5,  cantidadCupones: 20, cuponesGenerados: 0,  empresa_id: 'seed-siman',    rubro: 'clothing',       estado: 'en_espera', fecha_inicio: Timestamp.fromDate(en7),    fecha_fin: Timestamp.fromDate(en30) },
    ...
    { titulo: 'SEED - Ropa temporada (rechazada)',    descripcion: 'Rechazada por imágenes',         descuento: 40, tipo: 'porcentaje', costo_cupon: 6,  cantidadCupones: 25, cuponesGenerados: 0,  empresa_id: 'seed-zara',     rubro: 'clothing',       estado: 'rechazada', motivo_rechazo: 'Imágenes no cumplen los requisitos.', fecha_inicio: Timestamp.fromDate(en7), fecha_fin: Timestamp.fromDate(en30) },
    { titulo: 'SEED - Pizza descartada',             descripcion: 'Descartada por la empresa',      descuento: 20, tipo: 'porcentaje', costo_cupon: 4,  cantidadCupones: 15, cuponesGenerados: 0,  empresa_id: 'seed-pizzahut', rubro: 'restaurant',     estado: 'descartada',fecha_inicio: Timestamp.fromDate(en7),    fecha_fin: Timestamp.fromDate(en30) },
];
